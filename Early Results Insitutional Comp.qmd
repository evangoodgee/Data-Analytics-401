...
lm10Year = lm(log(Income10) ~ RUVH + RUH + RU + LMP + MMP + SMP + BCG + AdmissionPct + ACTScore75 + AVGFACSAL, data = EducationData)
...
# Multicolinearity
regVar = EducationData %>% select(Income10,RUVH, RUH, RU, LMP, MMP, SMP, BCG, BCAS,  AdmissionPct, ACTScore75, AVGFACSAL)
