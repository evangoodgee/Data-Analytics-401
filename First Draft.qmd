...
lm4YearHumanities = lm(log(EARN_MDN_4YR) ~ RUVH + RUH + RU + LMP + MMP + SMP + BCG + Public + AdmissionPct + GradRate + PELL_RT + log(AVGFACSAL), data = humanities)
